					...
					<div class="row">
						...
						<div class="col-md-6 animate fadeInRight">
							<div class="image-widget">
								<img src="{{asset('assets/frontend')}}/images/about-img1.jpg" class="img-shadow" alt="">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-4">
							<div class="team-member animate fadeInUp">
								...
								<ul class="social-text">
									<li><a class="facebook" href="about-us.html#.">facebook</a></li>
									<li><a class="twitter" href="about-us.html#.">twitter</a></li>
									<li><a class="youtube" href="about-us.html#.">youtube</a></li>
								</ul>
							</div>
						</div>
						<div class="col-md-4">
				...
				<div class="container">
					...
					<div class="two-items-carousel owl-carousel">
						<div class="partner animate fadeInLeft">
							<img src="{{asset('assets/frontend')}}/images/partners/1.jpg" alt="">
						...
						<div class="partner animate fadeInRight">
							<img src="{{asset('assets/frontend')}}/images/partners/2.jpg" alt="">
							<div class="partner-content">
